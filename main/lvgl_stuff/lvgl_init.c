...
void lvgl_init(void)
{
    ...
    lv_color_t *buf1 = heap_caps_malloc(EXAMPLE_LCD_H_RES * 70 * sizeof(lv_color_t), MALLOC_CAP_DMA);
    assert(buf1);
    lv_color_t *buf2 = heap_caps_malloc(EXAMPLE_LCD_H_RES * 70 * sizeof(lv_color_t), MALLOC_CAP_DMA);
    assert(buf2);
